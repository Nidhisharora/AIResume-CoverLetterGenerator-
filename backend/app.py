...
from services.gemini_service import generate_summary, generate_cover_letter,improve_project,enhance_skills
app = FastAPI()
...
def home():
    return {
        "message": "Welcome to AI Resume & Cover Letter Generator API 🚀"
    }
...
def improve_project_description(data: ProjectRequest):
    ...
    return {
        "improved_project": improved_project
    }
